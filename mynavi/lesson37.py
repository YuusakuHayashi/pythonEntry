...
file_out_iv = "out-invoice.xlsx"
file_out_ds = "out-delivery_slip.xlsx"
...
for y, row in enumerate(list_date):
    for x, cell in enumerate(now):
        if(cell in None) or (cell.value in None): continue
        v = cell.value
